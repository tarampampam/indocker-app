...
func TestLatest(t *testing.T) {
	...
	for name, tt := range map[string]struct {
		...
		"success": {
			...
			giveLocation:   "https://github.com/tarampampam/indocker-app/releases/tag/V1.2.0/foo/bar?baz=qux#quux",
			wantVersion:    "1.2.0",
		},
		"success without v prefix": {
			giveStatusCode: http.StatusFound,
			giveLocation:   "https://github.com/tarampampam/indocker-app/releases/tag/1.2.0/foo/bar?baz=qux#quux",
			wantVersion:    "1.2.0",
		},
