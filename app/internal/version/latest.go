...
// Latest returns the latest release tag of the "tarampampam/indocker-app" repository.
//
...
func Latest(ctx context.Context, useClient ...httpClient) (string, error) { //nolint:funlen
	var doer httpClient
	...
	const ownerAndRepo = "tarampampam/indocker-app"
